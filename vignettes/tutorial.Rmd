...
From 5-fold cross-validation, we have the prediction and could calculate misclassification rates.
...
Therefore, in practice I would choose `k_nn = 1` because both training and cross-validation identifies `k_nn = 1` with the minimum test error.
